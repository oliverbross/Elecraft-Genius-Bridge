...
async fn pgxl_polling_replay_is_stable() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "R3|0|state=STANDBY peakfwd=0.0000 swr=-30.0000 temp=32.0 id=0.0 vac=0 meffa=OK fault= connection_state=connected\n",
        )
    );
}
...
async fn tgxl_polling_replay_is_stable() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "R3|0|operate=0 bypass=0 tuning=0 relayC1=20 relayL=35 relayC2=20 antA=0 one_by_three=1 fwd=0.0000 swr=-30.0000 connection_state=connected fault=\n",
            "S0|state operate=0 bypass=0 tuning=0 relayC1=20 relayL=35 relayC2=20 antA=0 one_by_three=1 fwd=0.0000 swr=-30.0000 connection_state=connected fault=\n",
            "R4|0|operate=0 bypass=0 tuning=0 relayC1=20 relayL=35 relayC2=20 antA=0 one_by_three=1 fwd=0.0000 swr=-30.0000 connection_state=connected fault=\n",
            "S0|state operate=0 bypass=0 tuning=0 relayC1=20 relayL=35 relayC2=20 antA=0 one_by_three=1 fwd=0.0000 swr=-30.0000 connection_state=connected fault=\n",
            "R5|0|operate=0 bypass=0 tuning=0 relayC1=20 relayL=35 relayC2=20 antA=0 one_by_three=1 fwd=0.0000 swr=-30.0000 connection_state=connected fault=\n",
        )
    );
}
