...
To run real Tune/Standby controls from AetherSDR, load `config.aethersdr-compatible-operational.yaml`, review the COM ports and IP addresses, then enable only the actions you intend to test:
